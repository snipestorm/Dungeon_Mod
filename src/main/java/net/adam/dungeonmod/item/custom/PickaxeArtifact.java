...
public class PickaxeArtifact extends Item {

    public PickaxeArtifact(Item.Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        ...
        } else tooltip.add(Text.literal("Part Of The Pickaxe Set,").formatted(Formatting.AQUA));
