...
public class RuneArtifact extends Item {

    public RuneArtifact(Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        ...
        } else tooltip.add(Text.literal("Part Of The Rune Set,").formatted(Formatting.AQUA));
