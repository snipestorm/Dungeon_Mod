...
public class WardenArtifact extends Item {

    public WardenArtifact(Item.Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        ...
        } else tooltip.add(Text.literal("Part Of The Warden Set,").formatted(Formatting.AQUA));
