...
public class AstralArtifact extends Item {

    public AstralArtifact(Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        ...
        } else tooltip.add(Text.literal("Part Of The Astral Set,").formatted(Formatting.AQUA));
