...
public class EssenceArtifact extends Item {

    public EssenceArtifact(Settings settings) {
        super(settings);
    }
    ...
    public void appendTooltip(ItemStack stack, @Nullable World world, List<Text> tooltip, TooltipContext context) {
        ...
        } else tooltip.add(Text.literal("Part Of The Essence Set,").formatted(Formatting.AQUA));
